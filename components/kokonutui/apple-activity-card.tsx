...
const DetailedActivityInfo = ({ activitiesToShow }: { activitiesToShow: ActivityData[] }) => {
    return (
        <motion.div
...
export default function AppleActivityCard({
    ...
    className,
    activities: overrideActivities,
}: {
    title?: string;
    className?: string;
    activities?: ActivityData[];
}) {
    const activitiesToRender = overrideActivities ?? activities;
        ...
        >
            <div className="flex flex-col items-center gap-8">
                ...
                <div className="flex items-center">
                    ...
                    <DetailedActivityInfo activitiesToShow={activitiesToRender} />
                </div>
            </div>
        </div>
    );
