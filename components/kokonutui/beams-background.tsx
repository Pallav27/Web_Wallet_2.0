...
function createBeam(width: number, height: number, isDarkMode: boolean): Beam {
    ...
    // use greener hues (shifted toward lime/green)
    // lower the base hue and increase the range for more green variation
    const hueBase = isDarkMode ? 100 : 120;
    const hueRange = isDarkMode ? 60 : 50;
...
export default function BeamsBackground({
    ...
    useEffect(() => {
        ...
        function resetBeam(beam: Beam, index: number, totalBeams: number) {
            ...
            // use greener hues for beams on reset as well
            const hueBase = isDarkModeRef.current ? 100 : 120;
            const hueRange = isDarkModeRef.current ? 60 : 50;
        ...
        function drawBeam(ctx: CanvasRenderingContext2D, beam: Beam) {
            ...
            // slightly reduce lightness for richer green tones
            const saturation = isDarkModeRef.current ? "90%" : "80%";
            const lightness = isDarkModeRef.current ? "55%" : "40%";
